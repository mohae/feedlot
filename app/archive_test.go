...
func TestDirWalk(t *testing.T) {
	...
	if err == nil {
		...
		if err.Error() != "archive: invalid/path/to/archive does not exist" {
			t.Errorf("Expected \"archive: invalid/path/to/archive does not exist\", got %q", err)
		}
	}
}
...
func TestAddFilename(t *testing.T) {
	...
	if err == nil {
		...
		if "archive: ../test_files/src/ubuntu/scripts/dne_test_file.sh does not exist" != err.Error() {
			t.Errorf("Expected \"archive: ../test_files/src/ubuntu/scripts/dne_test_file.sh does not exist\", got %q", err)
		}
	}
}
