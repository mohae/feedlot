...
func init() {
	...
	contour.RegisterStringFlag(BuildFile, "b", "conf.d/build.toml", "conf.d/build.toml", "location of the build configuration file")
	contour.RegisterStringFlag(BuildListFile, "r", "conf.d/build_list.toml", "conf.d/build_list.toml", "location of the build list configuration file")
	contour.RegisterStringFlag(DefaultFile, "", "conf/default.toml", "conf/default.toml", "location of the default configuration file")
	contour.RegisterStringFlag(SupportedFile, "", "conf/supported.toml", "conf/supported.toml", "location of the supported distros configuration file")
