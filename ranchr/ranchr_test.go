...
func TestMergeSlices(t *testing.T) {
	...
	Convey("Testing MergeSlices", t, func() {
		...
		Convey("Given two populated slices with a duplicated element", func() {
			...
			So(res, ShouldResemble, []string{"apples = 1", "bananas=bunches", "oranges=10lbs", "apples= a bushel", "strawberries=some", "strawberries=2lbs", "mangoes=2", "starfruit=4"})
		})
